...
export default function PortfolioPage() {
  ...
  // Correlation warning: check for duplicate categories
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-0.5 text-xs text-text-muted">
                Claude searches the web, picks the best fades, and sizes with half-Kelly.
              </p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-xl border border-border bg-surface-1">
                ...
                {/* Market list — fixed width container */}
                    ...
                    filteredShocks.map((shock) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Mini probability bar — fixed width */}
                ...
                {selected.length === 0 ? (
                  ...
                  <div>
                    ...
                    {selected.map((s, i) => {
                      ...
                      const avgPnl =
                        stats?.backtest?.avg_pnl_per_dollar_6h;
                      const sampleSize = stats?.sample_size;
                      const fadeDir =
                        s.delta > 0 ? "Fade Down" : "Fade Up";
                              ...
                              {s.ai_analysis && (
                                <p className="mt-0.5 truncate text-xs text-text-muted">
                                  {s.ai_analysis.overreaction_assessment
                                    .length > 60
                                    ? s.ai_analysis.overreaction_assessment.substring(
                                        0,
                                        60,
                                      ) + "..."
                                    : s.ai_analysis
                                        .overreaction_assessment}
                                  <span
                ...
                <div className="rounded-lg border-l-4 border-amber-400 bg-surface-2 px-4 py-3">
                  ...
                  <p className="mt-1 text-xs text-text-secondary">
                    {correlationWarnings.map((w, i) => (
                      <span key={w.category}>
                        {i > 0 && ", "}
                        {w.count} positions in &ldquo;{w.category}
                        &rdquo;
                      </span>
                    ))}{" "}
                    may be correlated. Diversification benefit assumes
                    independent outcomes — correlated positions reduce actual
                    variance reduction.
                  </p>
                </div>
              )}
